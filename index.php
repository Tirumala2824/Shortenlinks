                ...
                <form class="card p-2 margin" method="POST" action="index.php">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button type="submit" name ="submit" class="btn btn-success">Reduce Url </button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <table class="table mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="http://localhost/project1/shorten?id=<?php echo $row->id; ?>" target="_blank" >http://localhost/project1/shorten?id=<?php echo $row->id; ?><a></td>
